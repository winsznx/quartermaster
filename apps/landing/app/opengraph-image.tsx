/**
 * Open Graph card for the landing page — 1200×630 PNG generated at
 * request time via next/og. Next.js auto-discovers this file and emits
 * the `og:image` + `twitter:image` meta tags pointing here.
 *
 * Composition: hero + tagline + emblem + URL. No external font fetches
 * (Satori falls back gracefully to system fonts) so build is self-
 * contained and the OG endpoint stays fast.
 */
import { ImageResponse } from "next/og";

export const runtime = "edge";
export const alt = "Quartermaster — keep your agents solvent.";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
          <div style={{ fontSize: 96, fontWeight: 400, lineHeight: 1.05, letterSpacing: -2 }}>
            Keep your agents solvent.
          </div>
          <div style={{ fontSize: 32, color: "#C9C4B5", maxWidth: 920, lineHeight: 1.35 }}>
            Autonomous treasury daemon for x402-paying AI agents. Five composable on-chain
            policies. Live on Base mainnet.
          </div>
        </div>
        <div
          style={{
        ...
        >
          <span style={{ fontFamily: "monospace" }}>quartermaster-landing.vercel.app</span>
